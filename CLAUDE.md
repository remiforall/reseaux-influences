...
npm run db:seed:enrichi          # enrichissement multi-cibles via les 23 connecteurs
...
| **Influence UE**          | eu-transparence (registre de transparence / lobbying UE, ADR-022)                 |
