...
export const COULEURS_NOEUDS = {
  ...
  PersonneEnAttente: { couleur: '#2563eb', icone: '◐', libelle: 'Personne (brouillon)', forme: 'circle-dashed' },
...
export const STYLES_ARETES = [
  ...
  { statut: 'EN_ATTENTE', libelle: "Lien en attente de validation", dasharray: '6 3', epaisseur: 1.5 },
