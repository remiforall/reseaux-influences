...
>
> **Responsable de traitement** : Rémi Vincent — PostHack (Normandie). *(Qualification à confirmer : éditeur seul, ou responsabilité conjointe art. 26 vu le modèle collaboratif — brief §4.2.)*
...
- **Avis DPO** : *(PostHack n'a pas de DPO désigné — à statuer : désignation nécessaire ?)*
