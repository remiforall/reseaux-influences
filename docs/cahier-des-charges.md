...
Le projet s'inscrit dans la continuité du projet *InfluenceNetwork* développé chez Owni.fr par Nicolas Kayser-Bril, en le modernisant avec des technologies contemporaines et un système de modération communautaire innovant.
